...
<html lang="en">
   ...
   <a href="logout.php"><button type="button" class="mx-4 btn btn-danger">Logout</button></a> 
    ...
    echo"  <div class='container rounded mt-2 bg-white p-md-5'>
          <div class='h2 font-weight-bold text-center'>debit History</div>
          
          ";
         include "connect.php";
         $query = "SELECT * FROM `debit` ORDER BY `id` DESC;" ;
              ...
              <table class='table'>
                  ...
                  <tbody>";
                      ...
                      <td class='pt-3'>{$rows['fname']}</td>
                          ...
                          <td class='pt-3'> <a class='btn btn-danger mx-1' href='del_debit.php?id={$rows['id']}' role='button'>delete</a></td>
                      </tr>
